...
public class PostServiceTest {
    ...
    public void setUp() {
        ...
        this.post = new Post("email@test.com", "Texto de teste.", new byte[]{}, PostTypes.NEWS, "Titulo Teste");
    ...
    public void testSaveEmailEmpty() {
        Post post = new Post("", "Texto de teste.", new byte[]{},  PostTypes.ENTERTAINMENT, "Titulo Teste");
        try {
    ...
    public void testSaveEmailNull() {
        Post post = new Post(null, "Texto de teste.", new byte[]{},  PostTypes.ENTERTAINMENT, "Titulo Teste");
        try {
            this.postService.save(post);
            Assert.fail("Uma exceção deveria ter sido lançada.");
        } catch (Exception e) {
    ...
    public void testSavePostTypeNull() {
        Post post = new Post("email@test.com", "Texto de teste.", new byte[]{},  null, "Titulo Teste");
        try {
            this.postService.save(post);
            Assert.fail("Uma exceção deveria ter sido lançada.");
        } catch (Exception e) {
