...
public class UserServiceTest extends SpottedApplicationTests {
    ...
    public void testSaveEmptyEmail() {
        User user = new User("", "thiagomoura", this.imgDefault);
        try {
            userService.save(user);
            Assert.fail("Uma exceção deveria ter sido lançada!");
        } catch (Exception e) {
    ...
    public void testSaveEmptyUsername() {
        User user = new User("thiago.moura@ccc.ufcg.edu.br", "", this.imgDefault);
        try {
            userService.save(user);
            Assert.fail("Uma exceção deveria ter sido lançada!");
        } catch (Exception e) {
    ...
    public void testSaveNullUsername() {
        User user = new User("thiago.moura@ccc.ufcg.edu.br", null, this.imgDefault);
        try {
            userService.save(user);
            Assert.fail("Uma exceção deveria ter sido lançada!");
        } catch (Exception e) {
    ...
    public void testSaveNullEmail() {
        User user = new User(null, "thiagomoura", this.imgDefault);
        try {
            userService.save(user);
            Assert.fail("Uma exceção deveria ter sido lançada!");
        } catch (Exception e) {
    ...
    public void testGetAll() {
        User user1 = new User("thiago.moura@ccc.ufcg.edu.br", "thiagomoura21", this.imgDefault);
        User user2 = new User("pedro.garcia@ccc.ufcg.edu.br", "pedrogarcia", this.imgDefault);
        User user3 = new User("emanuel.da.silva@ccc.ufcg.edu.br", "emanuelDaSilva", this.imgDefault);
    ...
    public void testFindUserByUsername() {
        ...
        User user2 = new User("thiago.santos@ccc.ufcg.edu.br", "thiagosantos", this.imgDefault);
        User user3 = new User("emanuel.da.silva@ccc.ufcg.edu.br", "emanuelDaSilva", this.imgDefault);
        User user4 = new User("pedro.garcia@ccc.ufcg.edu.br", "pedrogarcia", this.imgDefault);
    ...
    public void testFindUserByEmail() {
        ...
        User user1 = this.user;
        User user2 = new User("emanuel.da.silva@ccc.ufcg.edu.br", "emanuelDaSilva", this.imgDefault);
        userService.save(user1);
        userService.save(user2);
